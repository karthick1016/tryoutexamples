...
class Leaveapproval extends Database
{
    public function display($name)
    {
        ...
        $_SESSION['results'] = $leaveapproval;
    ...
    public function existDate($date)
    {
        $checkDate = "SELECT fromdate FROM leaveapprove WHERE fromdate = '$date'";
        $check = mysqli_query($this->conn,$checkDate);
